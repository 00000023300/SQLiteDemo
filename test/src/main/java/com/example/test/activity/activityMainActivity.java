    ...
    private void initView() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activityMainActivity.this, InsertActivity.class);
...
//                        studentAdapter.notifyDataSetChanged();
        ...
        btnPeople.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                        判断运行时权限
                if (ContextCompat.checkSelfPermission(activityMainActivity.this,
                        Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(activityMainActivity.this,
...
//        2.设置adapter
        if (cursors.isEmpty()) {
            Toast.makeText(activityMainActivity.this, "没有联系人", Toast.LENGTH_SHORT).show();
            return;
        }
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(activityMainActivity.this,
